...
_Part 1 — the combat engine — lives in [`ARCHITECTURE.md`](ARCHITECTURE.md). Part 3 — the open world, rooms, and client — in [`WORLD.md`](WORLD.md). The product vision and the room-partitioned shared world live in [`VISION.md`](VISION.md)._
