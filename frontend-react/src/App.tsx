  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      ...
      if (dir) {
        ...
        e.preventDefault();
        if (state.dialogue || state.lootReveal || state.shop || state.noticeboard || state.carriage || state.situation) return;
        ...
        if (object) {
          ...
          else if (object.interaction === "situation") api.openSituation(object.id);
